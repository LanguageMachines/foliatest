...
void editTest::test017(){
  ...
  CPPUNIT_ASSERT( word->xmlstring() == "<w xmlns=\"http://ilk.uvt.nl/folia\" xml:id=\"WR-P-E-J-0000000001.p.1.s.8.w.9\"><t>terwijl</t><errordetection class=\"spelling\"/><pos class=\"VG(onder)\"/><lemma class=\"terweil\"/></w>" );      
}
...
void editTest::test019(){
  cout << " Error Detection ";
  FoliaElement *word = doc["WR-P-E-J-0000000001.p.1.s.8.w.11"]; // stippelijn
  word->append( new ErrorDetection(&doc,"cls='spelling', annotator='testscript', annotatortype='auto'" ) );
  CPPUNIT_ASSERT( word->annotation<ErrorDetection>()->cls() == "spelling" );
}
